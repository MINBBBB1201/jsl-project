...
const inputSchema = new mongoose.Schema(
  {
    ...
    countryOfDestination: { type: String, trim: true, maxlength: 100, default: '' },
...
const tradeDocumentSchema = new mongoose.Schema(
  {
    ...
    type: { type: String, enum: TRADE_DOCUMENT_TYPES, required: true, index: true },
...
tradeDocumentSchema.index(
  ...
  { unique: true, partialFilterExpression: { documentNo: { $type: 'string' } } }
);
